                    ...
                    <template x-for='category in categories'>
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <div class="mt-2 space-y-2 rounded-md text-sm">
                                <template x-if='payload.hasOwnProperty(category.name)' x-for='(skill, position) in payload[category.name]'>
                                    <div class="flex border border-primary-500 rounded-md overflow-hidden font-bold">
                                        ...
                                        <div class="flex items-center p-2">
                                            <button class="text-gray-500 hover:text-gray-600" x-on:click='removeSkill(category.name, position)'>
